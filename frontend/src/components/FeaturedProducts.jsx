        ...
        <div className="flex gap-3 px-4 pb-2">
          {featuredProducts.map((product) => (
            <div
              ...
              className="min-w-[160px] max-w-[160px] bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden cursor-pointer hover:shadow-md transition-all duration-300 hover:-translate-y-1"
            >
              {/* Product Image */}
              <div className="relative w-full h-28 bg-gray-50 overflow-hidden">
                ...
                {/* Discount Badge */}
                {product.discount > 0 && (
                  <div className="absolute top-2 left-2 bg-red-500 text-white text-[10px] px-2 py-0.5 rounded-full font-semibold">
              ...
              <div className="p-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="w-8 h-8 bg-teal-600 rounded-lg flex items-center justify-center text-white hover:bg-teal-700 transition-colors active:scale-95"
                  >
